<div class="category_select">
    ...
    <div class="detail_content">
                ...
                foreach ($comment as $item) { ?>
                    <tr>
                        <td style="min-width: 100px"><?php for ($counter = $item->mark ; $counter>0;$counter--)
                            ...
                            ?></td>
                        <td><div style="width:220px;word-wrap: break-word"><?php echo $item->content ?></div></td>
                    </tr>
                    <?php $i++;
                }
            } ?>
        ...
        <form action="<?php echo base_url('home/comment') ?>" method="post">
            <input name="id" type="hidden" value="<?php echo $current_attr_id ?>">
            ...
            </select> <textarea class="ckeditor" name="comment"></textarea>
            <button style="margin: 20px auto 0 auto;" type="submit" class="btn btn-default">submit</button>
