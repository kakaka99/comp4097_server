...
<div style="    font-family: Verdana,Arial;
    ...
    <div style="margin: 20px auto; background: #FFFFFF;width:700px; padding: auto;">
        <div style="margin: auto;width:650px;">
            <br><br>
            Dear Gourmet User,<br><br>

            Please click on below URL or paste into your browser to reset your account password
            <?php echo base_url('member/reset/'.$forget_id)?> <br><br>
